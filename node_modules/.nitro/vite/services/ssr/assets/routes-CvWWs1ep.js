...
function StarField({ count = 120, className = "" }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [stars.map((s) => /* @__PURE__ */ jsx("span", {
		...
		}, s.id)), /* @__PURE__ */ jsx("style", { children: `@keyframes twinkle{0%,100%{opacity:.15;transform:scale(.8)}50%{opacity:1;transform:scale(1.1)}}` })]
	});
}
//#endregion
//#region src/components/Prologue.tsx
var LINES$1 = [
	"Loading...",
...
function Prologue({ onEnter }) {
	...
	return /* @__PURE__ */ jsxs(motion.section, {
		...
		children: [/* @__PURE__ */ jsx(StarField, { count: 180 }), /* @__PURE__ */ jsxs("div", {
			...
			children: [
				/* @__PURE__ */ jsxs("div", {
					...
					children: [LINES$1.slice(0, lineIdx).map((l, i) => /* @__PURE__ */ jsx("p", {
						className: "mb-2 opacity-60",
						children: l
					}, i)), lineIdx < LINES$1.length && /* @__PURE__ */ jsxs("p", {
						className: "mb-2",
						children: [typed, /* @__PURE__ */ jsx("span", { className: "ml-0.5 inline-block h-4 w-[2px] animate-pulse bg-ivory align-middle" })]
					})]
				}),
				/* @__PURE__ */ jsx(AnimatePresence, { children: showName && /* @__PURE__ */ jsxs(motion.h1, {
					initial: {
						opacity: 0,
						y: 20
					},
					...
					children: ["SARTHAK  ", /* @__PURE__ */ jsx("span", {
						className: "text-blush",
						children: "❤"
					})]
				}) }),
				/* @__PURE__ */ jsx(AnimatePresence, { children: showName && /* @__PURE__ */ jsx(motion.div, {
					initial: { opacity: 0 },
					animate: { opacity: 1 },
					transition: {
						duration: .6,
				...
				/* @__PURE__ */ jsx(AnimatePresence, { children: ready && /* @__PURE__ */ jsxs(motion.button, {
					initial: {
						opacity: 0,
						y: 20,
						scale: .95
...
//#endregion
//#region src/assests/favourite.jpg
var favourite_default = "/assets/favourite-DtEMwjCp.jpg";
//#endregion
//#region src/components/chapters/Welcome.tsx
function Welcome({ onBegin }) {
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [
			/* @__PURE__ */ jsx(StarField, { count: 150 }),
			/* @__PURE__ */ jsx("div", {
...
//#endregion
//#region src/components/chapters/OurStory.tsx
var EPISODES = [
	{
		n: 1,
		title: "The Beginning",
...
function OurStory() {
	...
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsx("div", {
					...
					children: EPISODES.map((e, i) => /* @__PURE__ */ jsxs(motion.button, {
						initial: {
							opacity: 0,
							y: 40
						},
		...
		}), /* @__PURE__ */ jsx(AnimatePresence, { children: ep && /* @__PURE__ */ jsx(motion.div, {
			initial: { opacity: 0 },
			animate: { opacity: 1 },
			exit: { opacity: 0 },
			...
			children: /* @__PURE__ */ jsxs(motion.div, {
				...
				children: [
					...
					/* @__PURE__ */ jsx("div", {
						...
						children: ep.photos.map((file, i) => /* @__PURE__ */ jsx(motion.div, {
							whileHover: { scale: 1.04 },
							transition: { duration: .3 },
							className: "overflow-hidden rounded-2xl border border-gold/20 bg-black shadow-2xl",
							children: file.type === "video" ? /* @__PURE__ */ jsx("video", {
								src: file.src,
								controls: true,
								autoPlay: true,
								muted: true,
...
//#endregion
//#region src/components/chapters/Museum.tsx
var FRAMES = [
	{
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsx("div", {
					...
					children: FRAMES.map((f, i) => /* @__PURE__ */ jsxs(motion.figure, {
						initial: {
							opacity: 0,
							y: 40
						},
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [f.type === "image" ? /* @__PURE__ */ jsx("img", {
								src: f.media,
								alt: f.title,
...
//#endregion
//#region src/components/chapters/Constellation.tsx
var REASONS = [
...
function Constellation() {
	const stars = useMemo(() => REASONS.map((r, i) => ({
		id: i,
		...
		children: [
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					stars.map((s) => /* @__PURE__ */ jsx("button", {
					...
					/* @__PURE__ */ jsx("style", { children: `@keyframes pulse{0%,100%{opacity:.7;transform:translate(-50%,-50%) scale(.9)}50%{opacity:1;transform:translate(-50%,-50%) scale(1.2)}}` })
				]
			}),
...
//#endregion
//#region src/components/chapters/Soundtrack.tsx
var SONGS = [
	{
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsx("div", {
					...
					children: SONGS.map((s, i) => /* @__PURE__ */ jsxs(motion.article, {
						initial: {
							opacity: 0,
							y: 40
						},
						...
						children: [
							/* @__PURE__ */ jsx("div", {
								...
								children: /* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx("div", { className: "absolute left-1/2 top-1/2 h-16 w-16 -translate-x-1/2 -translate-y-1/2 rounded-full border-4 border-black bg-gradient-to-br from-gold to-blush" }), /* @__PURE__ */ jsx("div", { className: "absolute left-1/2 top-1/2 h-2 w-2 -translate-x-1/2 -translate-y-1/2 rounded-full bg-black" })]
								})
							}),
							/* @__PURE__ */ jsx("h3", {
...
//#endregion
//#region src/components/chapters/Adventures.tsx
var PINS = [
	{
		name: "Where We Met",
		x: 22,
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsxs("div", {
					...
					}), PINS.map((p, i) => /* @__PURE__ */ jsxs("button", {
						onClick: () => setActive(i),
			...
			children: /* @__PURE__ */ jsxs(motion.div, {
				...
				children: [
					...
					/* @__PURE__ */ jsx("div", {
						...
						children: PINS[active].type === "image" ? /* @__PURE__ */ jsx("img", {
...
//#endregion
//#region src/components/chapters/Letters.tsx
var LETTERS = [
	{
...
function Letters() {
	...
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsx("div", {
					...
					children: LETTERS.map((l, i) => /* @__PURE__ */ jsxs(motion.button, {
						initial: {
							opacity: 0,
							y: 30
						},
						...
						children: [/* @__PURE__ */ jsx("div", { className: "absolute -right-4 -top-4 h-24 w-24 rotate-12 bg-blush/40 blur-2xl" }), /* @__PURE__ */ jsxs("div", {
							className: "relative",
							children: [
								/* @__PURE__ */ jsx("div", {
									className: "text-4xl",
		...
		}), /* @__PURE__ */ jsx(AnimatePresence, { children: open !== null && /* @__PURE__ */ jsx(motion.div, {
			initial: { opacity: 0 },
			animate: { opacity: 1 },
			exit: { opacity: 0 },
			onClick: () => setOpen(null),
...
//#endregion
//#region src/components/chapters/Future.tsx
var DREAMS = [
	{
	...
	return /* @__PURE__ */ jsx("section", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsx("div", {
					className: "mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-3",
					children: DREAMS.map((d, i) => /* @__PURE__ */ jsxs(motion.div, {
						initial: {
							opacity: 0,
							y: 30
						},
						...
						children: [
							...
							/* @__PURE__ */ jsx("div", { className: "mt-6 h-px w-16 bg-gradient-to-r from-gold to-transparent" }),
							/* @__PURE__ */ jsx("p", {
...
//#endregion
//#region src/components/chapters/Finale.tsx
var LINES = [
	"Thank you...",
	"For every smile.",
	"Every laugh.",
	...
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [
			...
			/* @__PURE__ */ jsxs("div", {
				...
				}, p.id)), /* @__PURE__ */ jsx("style", { children: `@keyframes float{0%{transform:translateY(0);opacity:0}10%{opacity:.9}100%{transform:translateY(-120vh);opacity:0}}` })]
			}),
			/* @__PURE__ */ jsxs("div", {
				className: "relative z-10 flex min-h-screen flex-col items-center justify-center px-6 py-24 text-center",
				children: [
					LINES.map((l, i) => /* @__PURE__ */ jsx(motion.p, {
						initial: {
							opacity: 0,
							y: 20
						},
					...
					/* @__PURE__ */ jsxs(motion.p, {
						...
						children: ["To Be Continued... ", /* @__PURE__ */ jsx("span", {
							className: "text-blush",
							children: "❤"
						})]
					})
...
//#endregion
//#region src/components/EasterEggs.tsx
function EasterEggs() {
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [
		...
		/* @__PURE__ */ jsx("style", { children: `@keyframes hb{0%,100%{transform:scale(1)}50%{transform:scale(1.2)}}` }),
		/* @__PURE__ */ jsx("button", {
			onClick: () => setModal({
		...
		/* @__PURE__ */ jsx("button", {
			...
			children: /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("div", { className: "h-3/4 w-full bg-gradient-to-br from-blush/40 to-midnight/40" }), /* @__PURE__ */ jsx("span", {
		...
		/* @__PURE__ */ jsx(AnimatePresence, { children: modal && /* @__PURE__ */ jsx(motion.div, {
			initial: { opacity: 0 },
			animate: { opacity: 1 },
			exit: { opacity: 0 },
...
function Index() {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx(AnimatePresence, { children: !entered && /* @__PURE__ */ jsx(Prologue, { onEnter: handleEnter }, "prologue") }), entered && /* @__PURE__ */ jsxs(motion.div, {
			initial: {
				opacity: 0,
				scale: 1.08
			},
			...
			children: [
				/* @__PURE__ */ jsx(Welcome, { onBegin: scrollToStory }),
				/* @__PURE__ */ jsx("div", {
					ref: beginRef,
					id: "chapter-2",
					children: /* @__PURE__ */ jsx(OurStory, {})
				}),
				/* @__PURE__ */ jsx(Museum, {}),
				/* @__PURE__ */ jsx(Constellation, {}),
				/* @__PURE__ */ jsx(Soundtrack, {}),
				/* @__PURE__ */ jsx(Adventures, {}),
				/* @__PURE__ */ jsx(Letters, {}),
				/* @__PURE__ */ jsx(Future, {}),
				/* @__PURE__ */ jsx(Finale, {}),
				/* @__PURE__ */ jsx(EasterEggs, {})
			]
		})]
	});
}
